...
export default function WelcomePage() {
  ...
  const opactiyCity = useTransform(
    scrollY,
    [0, 200, 300, 400, 500],
    [1, 0.5, 0.5, 0.3, 0]
  );
  ...
  const opactiyHero = useTransform(scrollY, [0, 300, 500], [1, 1, 0]);
  ...
  return (
    <>
      <header id="welcome-header">
        ...
        <motion.img
          style={{ opacity: opactiyCity, y: yCity }}
          src={cityImg}
          alt="A city skyline touched by sunlight"
          id="city-image"
        />
        <motion.img
          style={{ opacity: opactiyHero, y: yHero }}
          src={heroImg}
